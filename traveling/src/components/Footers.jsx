...
const Footer = () => {
  return (
    <footer className="bg-surface dark:bg-surface text-surface dark:text-surface pt-12 mt-10">
      <div className="container grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-gray-200 dark:border-gray-700">
        {/* Logo / About */}
        <div>
          <h2 className="text-2xl font-bold text-primary mb-4">Pak Railfan</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-surface sm:text-sm  font-semibold">
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-surface text-sm font-semibold">
            <li>
        ...
        <div>
          ...
          <p className="text-surface text-sm mb-2">Email: info@email.com</p>
          <p className="text-surface text-sm mb-4">Phone: +92 123 456 789</p>
      ...
      {/* Bottom Footer */}
      <div className="text-center text-surface text-sm py-6">
